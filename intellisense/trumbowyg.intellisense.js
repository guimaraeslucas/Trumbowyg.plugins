/**
 * Trumbowyg - intellisense Plugin
 *
 * This plugin enhances the editor by simulating an IntelliSense-like feature. It allows a
 * suggestion box to be triggered by a specific character (e.g., /), fetching dynamic content
 * from a backend endpoint and inserting it directly into the editor. It's perfect for
 * creating templates, canned responses, or dynamic snippets.
 * Trumbowyg is a program by <alex-d.github.io/Trumbowyg>
 *
